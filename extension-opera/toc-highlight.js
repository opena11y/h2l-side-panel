...
const HIGHLIGHT_CLASS = 'toc-highlight';
...
class TOCHighlightElement extends HTMLElement {
...
window.customElements.define(HIGHLIGHT_ELEMENT_NAME, TOCHighlightElement);
